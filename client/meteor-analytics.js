...
var trackEventWhenReady = function() {
    ...
    analytics.ready(function() {
        analytics.track.apply(this, _args);
    });
};
...
var identifyWhenReady = function() {
    var _args = arguments;
    analytics.ready(function() {
        analytics.identify.apply(this, _args);
    });
};
...
getUserEmail = function() {
    if (Meteor.userId()) {
        var user = AnalyticsUsers.findOne({
            _id: Meteor.userId()
        }, {
            fields: {
                emails: 1,
...
var trackLogins = function() {
    ...
    if (initialized) {
        ...
        if (Meteor.userId()) {
            ...
            identifyWhenReady(Meteor.userId(), {
                email: userEmail
            });
